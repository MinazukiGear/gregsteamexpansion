...
状态核对日期：2026-09-13；发布基线：`v0.1.0-alpha.3`。当前处于 Alpha 测试阶段；全部机器的基础游戏内运行冒烟测试已由用户确认通过，主任务转为验证生存获取与生产闭环、存档稳定性、异常恢复和跨模组自动化。工程重构 P0～P2 已完成，历史实现和门禁记录见[工程路线图](../refactor-roadmap.md)。

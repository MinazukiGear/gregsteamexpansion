...
final class GSEMachineTooltips {
    ...
    private static void appendBlastFurnaceTooltip(ItemStack stack, List<Component> tooltip) {
        ...
        tooltip.add(Component.translatable(
                "gregsteamexpansion.machine.large_steam_blast_furnace.tooltip.hot_blast.structure")
                .withStyle(ChatFormatting.DARK_AQUA));
        tooltip.add(Component.translatable(
                "gregsteamexpansion.machine.large_steam_blast_furnace.tooltip.hot_blast.cycle")

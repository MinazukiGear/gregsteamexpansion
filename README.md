...
- **蒸汽仓室体系**：蒸汽供给仓、仅大型机器可用且供汽量为四倍的 256,000 mB 大型蒸汽供给仓、蒸汽排气仓、蒸汽流体输入/输出仓、蒸汽空气进气仓，替代上游蒸汽输入仓；排气仓带阻塞判定与排气灼伤机制。
...
.\gradlew.bat runGameTestServer     # 运行全部 GameTest（103 个，见下）
